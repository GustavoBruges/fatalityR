...
#' @examples \dontrun{
#' fars_fileame <- make_filename(2013)
#' }
#'
#' @export
...
#' Creates a dataframe from FARS data from multiple years as specified by the years parameter
#'
...
#' Creates a map of accident locations for one as specified by the year parameter for the 
#' state specified by FIPS code using the state.num parameter.
#' 
...
#'
#' @param year Year of FARS input data to us
#' @param state.num FIPS code of the state to create a map for
#' @return A map of accident locations for state with FIPS code tate.num in year year. 
#' 
